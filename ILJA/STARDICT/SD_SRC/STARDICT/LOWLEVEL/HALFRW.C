...
‘ункции дл€ записи/чтени€  в файлы порци€ми по пол-байта.
ќснованы на использовании буферизации BufRead и BufWrite.
»спользуютс€ при кодировании текстов в data.dat
